...
---
Table R1. **Performance comparison on a synthetic constrained optimization benchmark of SSL warm-started from different SL pretraining steps. SL achieves lowest validation merit at around epoch 250.** We use $7{,}000$ inexact labels (with a maximum CPU solve time of 2.0 s per label) for supervised warm-starting, 
