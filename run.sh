...
for seed in 0 1 2 3
do
    python main.py     --method FSNet     --prob_type nonsmooth_nonconvex     --prob_name socp    --seed $seed     --num_epochs 300     --checkpoint "results/nonsmooth_nonconvex/socp/SOCPProblem-100-50-50-10000/20251024-142312_MLP_sup_seed1_dropout0.1/model_20.pt"
    ...
    # python main.py     --method FSNet     --prob_type nonconvex     --prob_name socp    --seed $seed     --num_epochs 300
