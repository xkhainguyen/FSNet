...
echo "=== train FSNet on nonsmooth_nonconvex QP $(date) on $SLURM_NODELIST ==="
python main.py --method FSNet --prob_type nonsmooth_nonconvex --prob_name qp \
