...
echo "=== train DC3 on nonsmooth_nonconvex SOCP $(date) on $SLURM_NODELIST ==="
python main.py --method DC3 --prob_type nonsmooth_nonconvex --prob_name socp \
