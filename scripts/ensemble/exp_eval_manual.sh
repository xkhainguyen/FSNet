...
# agg="greedy_merit"
# size=10
# VANILLA_DIR="results/nonsmooth_nonconvex/socp/SOCPProblem-100-50-50-10000/20260227-145738_penalty_seed2025_e1000_lr1e-04_n7000_ens10_vanilla_pre"

# echo "Vanilla dir: $VANILLA_DIR"

# if [ -n "$VANILLA_DIR" ]; then
#     for size in 4 7 10; do
#         echo "--- eval size=$size ---"
